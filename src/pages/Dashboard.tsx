        ...
        <div className="grid grid-cols-12 gap-6">
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {isHot && (
                            <span className="h-[6px] w-[6px] rounded-full bg-brass" style={{ boxShadow: '0 0 6px #ffbb3960' }} />
                          )}
                        </div>
          ...
          <div className="col-span-12 space-y-5 lg:col-span-4">
            ...
            <div className="relative overflow-hidden rounded-[12px] p-5" style={{ background: '#2A2118' }}>
              {/* Brass top line */}
              <div className="absolute left-0 right-0 top-0 h-[2px]" style={{ background: 'linear-gradient(90deg, #ffbb39, transparent)' }} />
              ...
              <p className="text-[13px] leading-relaxed" style={{ color: '#B8B0A5' }}>
                ...
                <span className="font-semibold" style={{ color: '#ffbb39' }}>23% larger deals</span> on average.
              </p>
