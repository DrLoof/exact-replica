      ...
      switch (step) {
        ...
        case 6:
          ...
          if (!existingTerms?.length) {
            const defaultTerms = [
              { title: 'Payment Terms', content: 'All fees are due according to the payment schedule outlined in the Investment section of this proposal. Invoices will be issued at each milestone and are payable within 14 days of receipt. Late payments may incur a charge of 1.5% per month on the outstanding balance. Work may be paused on accounts with payments overdue by more than 30 days. All prices quoted are exclusive of applicable taxes unless otherwise stated.', display_order: 1 },
              { title: 'Project Timeline & Milestones', content: 'The project timeline outlined in this proposal is an estimate based on the defined scope of work. Actual timelines may vary depending on the timely provision of client feedback, content, assets, and approvals. Delays in client deliverables may result in corresponding delays to the project schedule. We will communicate any anticipated changes to the timeline promptly and work collaboratively to minimize impact.', display_order: 2 },
              { title: 'Revision Policy', content: 'This proposal includes the number of revision rounds specified per deliverable. A revision is defined as a set of consolidated feedback provided at one time. Additional revision rounds beyond the included allowance will be billed at our standard hourly rate. Major changes to the agreed scope, direction, or strategy after approval may constitute new work and will be quoted separately.', display_order: 3 },
              { title: 'Intellectual Property', content: 'Upon receipt of full and final payment, the client will receive full ownership of all final deliverables created specifically for this project. This includes design files, code, copy, and other materials as outlined in the deliverables. The agency retains the right to use project work in portfolios, case studies, and marketing materials unless otherwise agreed in writing. Any pre-existing intellectual property, frameworks, tools, or templates used in the creation of deliverables remain the property of the agency and are licensed for the client\'s use.', display_order: 4 },
              { title: 'Confidentiality', content: 'Both parties agree to keep confidential any proprietary or sensitive information shared during the course of this engagement. This includes but is not limited to business strategies, financial information, customer data, technical specifications, and unpublished creative work. Confidential information will not be disclosed to third parties without prior written consent. This obligation survives the termination of this agreement for a period of two years.', display_order: 5 },
              { title: 'Termination', content: 'Either party may terminate this agreement with written notice as specified in the notice period above. In the event of termination, the client will be invoiced for all work completed up to the termination date, plus any committed third-party costs. Any deposits or advance payments for work not yet started will be refunded within 30 days. Termination does not affect either party\'s rights or obligations that accrued prior to the termination date.', display_order: 6 },
              { title: 'Liability', content: 'The agency\'s total liability under this agreement shall not exceed the total fees paid by the client for the services. The agency shall not be liable for any indirect, incidental, consequential, or special damages arising from or related to this agreement. The agency does not guarantee specific business results, rankings, traffic levels, or conversion rates, as these are influenced by many factors beyond the agency\'s control. Both parties will make reasonable efforts to resolve any disputes through good-faith negotiation before pursuing formal resolution.', display_order: 7 },
              { title: 'Governing Law', content: 'This agreement shall be governed by and construed in accordance with the laws of [Agency Jurisdiction]. Any disputes arising from this agreement shall be resolved through mediation before either party may pursue litigation. Both parties consent to the jurisdiction of the courts located in [Agency Jurisdiction] for any legal proceedings related to this agreement.', display_order: 8 },
