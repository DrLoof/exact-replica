...
export function ServiceCard({
  ...
  const renderResponsibilitiesEdit = () => editableResp && renderListAddButton(addingResp, setAddingResp, newResp, setNewResp, onClientResponsibilitiesEdit!, clientResponsibilities || [], "responsibility", respSuggestions);
  const renderOutOfScopeEdit = () => editableOos && renderListAddButton(addingOos, setAddingOos, newOos, setNewOos, onOutOfScopeEdit!, outOfScope || [], "out of scope item", oosSuggestions);
