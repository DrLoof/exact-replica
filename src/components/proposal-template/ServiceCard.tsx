...
export function ServiceCard({
  ...
  if (isSoft) {
    ...
    return (
      <motion.div
        ...
        className="group/card relative rounded-2xl p-7 transition-all duration-300"
        style={{
  ...
  if (isModern) {
    ...
    return (
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay, duration: 0.5, ease: "easeOut" }}
        className="group/card relative rounded-3xl p-7 transition-transform duration-300 hover:-translate-y-1"
        style={{
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay, duration: 0.5, ease: "easeOut" }}
      className="group/card relative bg-white border border-[#EBEBEB] rounded-2xl p-8 transition-all duration-300"
