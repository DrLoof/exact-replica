  ...
  'Website & Digital': [
    {
      ...
      clientResponsibilities: [
        'Provide all page copy and imagery (or engage copywriting module)',
        'Provide brand guidelines and logo files',
        'Designate one decision-maker for design approvals',
        'Provide timely feedback within agreed review windows (5 business days)',
        'Manage domain registration and DNS settings',
        'Provide hosting environment credentials or agree to recommended hosting',
      ],
      outOfScope: [
        'Copywriting',
